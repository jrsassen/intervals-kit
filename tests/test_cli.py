...
from intervals_icu_tools.cli import cli
from intervals_icu_tools.errors import AuthenticationError, RateLimitError, NotFoundError, DownloadError
...
class TestListActivities:
    def test_success_prints_json(
        ...
        with patch("intervals_icu_tools.cli.commands.IntervalsService") as MockSvc:
