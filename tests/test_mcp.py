...
from intervals_kit.mcp_server import mcp
from intervals_kit.errors import AuthenticationError, RateLimitError, NotFoundError
...
class TestListActivities:
    async def test_returns_activity_list(
        ...
        from intervals_kit.models import Activity
        activities = [Activity.model_validate(a) for a in sample_activities]
        with patch("intervals_kit.mcp_server._make_service") as mock_svc:
